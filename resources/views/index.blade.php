...
<div class="row tm-welcome-content">
          ...
          <p class="gray-text tm-welcome-description" style="text-align:center">Halo Coffee Snob, silahkan pesan menu favorit kalian. Nikmati hari - hari penuh canda tawa kalian
                                                      dengan spesial menu dari TiaraDev Cafe. Jangan lewatkan juga promo - promo menarik dari kami.<span class="gold-text"> HAVE A NICE DAY!</span>
      ...
      <div class="container" id="main">
        <section class="tm-section row">
          <div class="col-lg-9 col-md-9 col-sm-8">
            ...
            <h2>TiaraDev Cafe</h2>
            <p class="tm-welcome-description">Weekend emang paling seru nongkrong rame-rame bareng teman, keluarga ataupun doi! Nikmati serunya Weekendmu ditemani dengan aroma sedap kopi  dari @TiaraDev_Cafe. Semua jenis kopi tersedia dan tentunya makanan pendukung yang enak-enak!<br><br>
              Jangan lupa untuk follow @TiaraDev_Cafe untuk selalu dapetin info promo menarik lainnya juga yah. Yuk, langsung aja cek aplikasi Grabfood atau Gofood kamu untuk tahu lokasi terdekatmu ya!</p>
          ...
          <div class="row">
            <div class="tm-daily-menu-container margin-top-60">
              ...
              <div class="col-lg-8 col-md-8">
                <p>YEAY!! HARI INI Kalian masih bisa nikmati Promo Tahun baru TiaraDev Cafe dengan harga spesial mulai dari Rp. 27.273,-<br><br>
                ...
                <ol class="margin-top-30">
                  ...
                  <li>Berlaku di seluruh outlet TiaraDev Cafe.</li>
