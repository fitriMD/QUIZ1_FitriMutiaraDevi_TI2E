...
@section('content')
        ...
        <div class="row tm-welcome-content">
          ...
          <p class="gray-text tm-welcome-description" style="align-text:center">Ada kabar gembira nihhhh, TiaraDev Cafe akan memberikan informasi terkait menu - menu yang menjadi favorit
          ...
          <div class="row">
            <div class="tm-daily-menu-container margin-top-60">
              ...
              <p>YEAY!! HARI INI Kalian masih bisa nikmati Promo Tahun baru TiaraDev Cafe dengan harga spesial mulai dari Rp. 27.273,-<br><br>
                ...
                <p>Jika Kalian membutuhkan informasi lebih terkait daftar menu yang tersedia di TiaraDev Cafe, TiaraDev Cafe bisa 
