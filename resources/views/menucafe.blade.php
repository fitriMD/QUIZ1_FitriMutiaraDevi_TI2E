...
@section('content')
        ...
        <div class="row tm-welcome-content">
          ...
          <p class="gray-text tm-welcome-description" style="text-align:center">Selamat datang di halaman menu kami, yuk pilih menu favorit kalian untuk menemani hari yang cerah ini.
                                                      Jangan lupa untuk abadikan momen ini dengan hastag <span class="gold-text">#haricerahbersamaTiaraDevCafe</span>
      ...
      <div class="container" id="main">
        <section class="tm-section row">
          <div class="col-lg-9 col-md-9 col-sm-8">
            ...
            <h2>TiaraDev Cafe</h2>
            <p class="tm-welcome-description">Untuk varian menu lain, kalian bisa klik button dibawah untuk informasi lengkap.
