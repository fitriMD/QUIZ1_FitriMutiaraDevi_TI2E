...
@section('content')
        <div class="row tm-welcome-content">
          ...
          <h2 class="gold-text tm-welcome-header-2">TiaraDevi Cafe</h2>
          <p class="gray-text tm-welcome-description" style="text-align:center">Jika kalian membutuhkan informasi lebih terkait TiaraDevi Cafe, 
